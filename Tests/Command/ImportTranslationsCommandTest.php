...
class ImportTranslationsCommandTest extends WebTestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertRegExp('/translations\/LexikTranslationBundle\.((fr)|(en))\.yml" \.\.\. 18 translations/', $resultLines[2]);
        $this->assertRegExp('/translations\/LexikTranslationBundle\.((fr)|(en))\.yml" \.\.\. 18 translations/', $resultLines[3]);
